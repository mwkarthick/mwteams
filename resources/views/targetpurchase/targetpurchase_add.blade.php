...
@section('title', 'Target Purchase Add')
@section('page_title', 'Target Purchase Add')
        ...
        <div class="card-body card-padding">
            ...
            <div class="row">
                <?php $currentdate =date('Y-m-d'); 
                    ...
                    <form id='readcsvform' role="form" action="{{url('targetpurchase/readcsv')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                    ...
                    <hr>
                    <form class="p-5 m-t-20" id="targetupload" role="form" action="{{url('targetpurchase/readcsv')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="form-group col-sm-6">
