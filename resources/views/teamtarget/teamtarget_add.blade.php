...
@section('title', 'Teams')
@section('page_title', 'Team Traget')
@section('page_icon_cls', 'fa-building')

@section('page_master_li_cls', 'toggled active')
@section('page_teamtarget_li_cls', 'toggled active')
@section('page_teamtarget_li_list_cls', 'active')
@section('page_teamtarget_li_add_cls', '')
        ...
        <div class="card-body card-padding">
            ...
            <div class="row">
                <?php $currentdate =date('Y-m-d'); 
                    ...
                    <form id='readcsvform' role="form" action="{{url('teamtarget/readcsv')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                    ...
                    <hr>
                    <form class="p-5 m-t-20" id="targetupload" role="form" action="{{url('teamtarget/readcsv')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="form-group col-sm-6">
            ...
            $(".uploadtarget").click(function()
            {
                ...
                $.ajax({
                    ...
                    if(len > 0)
                    {
                        ...
                        swal("warning",data.errorlog+" Teams not found");
                    }
