 ...
 *
 */
public class DeliveryInstructForSpares_1621916122850_476750 extends JREvaluator
{
    ...
    private JRFillParameter parameter_BASE_DESIGN = null;
    ...
    private void initParams(Map pm)
    {
        ...
        parameter_BASE_DESIGN = (JRFillParameter)pm.get("BASE_DESIGN");
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            case 0 : 
            {
                value = (java.lang.String)(((java.lang.String)parameter_BASE_DESIGN.getValue())+"/com/ssm/sales/management/erpReports/");//$JR_EXPR_ID=0$
                break;
            }
            case 1 : 
            {
