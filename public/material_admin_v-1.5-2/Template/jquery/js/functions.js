...
$(document).ready(function(){
    ...
    (function(){
        //Toggle
        $('body').on('click', '#menu-trigger, #chat-trigger, #attendance-trigger', function(e){
            e.preventDefault();
            ...
            if (x == '#sidebar') {
                ...
                $('#attendance-trigger').removeClass('open');
                ...
                if (!$('#chat').hasClass('toggled')) {
                    ...
                    //$('#attendance').removeClass('toggled');
                }
                if (!$('#attendance').hasClass('toggled')) {
                    $('#header').toggleClass('sidebar-toggled');
                }
                else {
                    $('#attendance').removeClass('toggled');
    ...
    */
     ...
     */
    // selfreg
    if ($('.form-wizard-basic.selfreg')[0]) {
        $('.form-wizard-basic.selfreg').bootstrapWizard({
            tabClass: 'fw-nav',
